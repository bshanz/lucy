...
- **You must know when the tables drop.** Either the exact moment, or "opens N days ahead at HH:MM". If you don't know a venue's rule, **ask him** — don't guess. A snipe armed for the wrong minute doesn't error, it just quietly loses, and he finds out the night he expected to be eating.
